...
def _init_preset_agents(conn):
    ...
    presets = [
        ...
        {
            "name": "加减仓分析师",
            "description": "专注基金加减仓决策的事前预警，结合估值、仓位、历史三维度分析，给出🚦信号等级（绿灯/黄灯/红灯/黑灯）",
            "system_prompt": (
                "## 人设\n"
                "你是一位严谨的基金投资风控分析师，专注于加减仓决策的事前预警和事后复盘。\n"
                "你有 15 年基金研究经验，见过太多「追涨杀跌」的惨痛案例，\n"
                "所以你的核心价值是：在用户冲动操作前，用数据和逻辑帮他冷静下来。\n\n"

                "## 信号等级定义\n"
                "- 🟢 **绿灯**：操作合理，估值和仓位都在安全区间，放心执行\n"
